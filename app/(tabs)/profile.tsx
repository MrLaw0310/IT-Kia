...
export default function ProfileScreen() {
  ...
  return (
    <View style={[styles.screen, { backgroundColor: "transparent" }]}>
      ...
      {/* 星级评分弹窗，未选为空心，选后对应不同弹窗
          Star rating modal — hollow stars until tapped, each star shows unique message */}
      <Modal
        transparent
        visible={ratingVisible}
        animationType="fade"
        onRequestClose={() => { setRatingVisible(false); setHoveredStar(0); }}
      >
        <View style={{ flex: 1, backgroundColor: "rgba(0,0,0,0.5)", justifyContent: "center", alignItems: "center" }}>
          <View style={{ backgroundColor: T.card, borderRadius: 20, padding: 28, width: 300, alignItems: "center", borderWidth: 1, borderColor: T.border }}>
            ...
            {/* 悬停或已选显示实心星，否则空心 / filled when hovered, hollow otherwise */}
